...
class GMailMessage(object):
  ...
  def create_message(self) -> Dict[str, Any]:
    ...
    message['from'] = (f'Report2BQ on {self._project} '
                       f'<noreply-report2bq@google.com>')
    message['subject'] = self._subject
    body = {'raw': urlsafe_b64encode(
...
class GMail(object):
  def send_message(self, message: str, credentials: Credentials) -> None:
