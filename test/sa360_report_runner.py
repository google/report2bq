...
def main(unusedargv):
  ...
  runner = SA360ReportRunner(report_id='holiday_2020_20700000000000942_21700000001478610', email='davidharcombe@google.com', project='report2bq-zz9-plural-z-alpha')
  r = runner.run()
